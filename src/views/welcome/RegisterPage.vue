            ...
            <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
                ...
                <el-form-item prop="code">
                    <el-row style="width: 100%">
                        <el-col>
                            <el-input v-model="form.code" :maxlength="6" type="text" model-value="123456">
                                <template #prefix>
...
import {defaultFailure,defaultError} from "@/util/index";
...
const rules = {
    ...
    code: [
        { required: false, message: '请输入获取的验证码', trigger: 'blur' },
    ]
}
...
const register = () => {
  axios.post('/user/sign-up', {
    ...
    if(response.data === 'failed') {
      defaultFailure("用户名已被其他用户占用，请更新后重试");
    }else {
      ElMessage.success("注册成功");
      store.auth.token=response.data;
